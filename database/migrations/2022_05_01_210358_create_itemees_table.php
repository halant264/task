...
class CreateItemeesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('itemees', function (Blueprint $table) {
                 $table->id();
            $table->string('title');
            ...
            $table->tinyInteger('in_orderes' , 1)->default(1);
            ...
            $table->integer('parent_id' ) ->length(20)->nullable();
        });
    }
